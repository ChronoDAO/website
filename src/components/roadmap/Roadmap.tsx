  ...
  useEffect(() => {
    ...
    ScrollTrigger.create({
      ...
      onEnter: () => {
        ...
        gsap.fromTo(img1, { rotation: 0 }, { rotation: 180, duration: 5 });
      },
      onLeaveBack: () => {
        gsap.fromTo(section1, { opacity: 1 }, { opacity: 0, duration: 1 });
      },
    ...
    ScrollTrigger.create({
      ...
      onEnter: () => {
        ...
        gsap.fromTo(img2, { rotation: 0 }, { rotation: 180, duration: 5 });
      },
      onLeaveBack: () => {
        gsap.fromTo(section2, { opacity: 1 }, { opacity: 0, duration: 1 });
      },
    });
    ...
    ScrollTrigger.create({
      ...
      onEnter: () => {
        ...
        gsap.fromTo(img3, { rotation: 0 }, { rotation: 180, duration: 5 });
      },
      onLeaveBack: () => {
        gsap.fromTo(section3, { opacity: 1 }, { opacity: 0, duration: 1 });
      },
    });
  }, []);
